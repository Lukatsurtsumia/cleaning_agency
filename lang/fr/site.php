    ...
    'services' => [
        ...
        'items' => [
            [
                ...
                'points' => ['Recouches et mises à blanc', 'Parties communes', 'Gestion du linge', 'Contrôle qualité'],
                'icon' => 'bed',
            ],
            [
                'key' => 'immeubles',
                ...
                'points' => ['Halls et cages d\'escalier', 'Ascenseurs', 'Locaux poubelles', 'Sorties de conteneurs'],
                'icon' => 'building',
            ],
            [
                'key' => 'bureaux',
                ...
                'points' => ['Postes de travail', 'Sanitaires', 'Salles de réunion', 'Espaces de pause'],
                'icon' => 'briefcase',
            ],
            [
                'key' => 'specifiques',
                ...
                'points' => ['Vitrerie', 'Remise en état après travaux', 'Désinfection', 'Intervention urgente'],
                'icon' => 'spray',
            ],
        ],
    ],
