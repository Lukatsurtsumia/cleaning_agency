    ...
    'services' => [
        ...
        'items' => [
            [
                ...
                'points' => ['Guest rooms and bathrooms', 'Corridors and lobbies', 'Fresh linen and towels', 'Shared areas'],
                'icon' => 'bed',
            ],
            [
                'key' => 'immeubles',
                ...
                'points' => ['Entrance halls', 'Staircases and landings', 'Lifts', 'Bin areas'],
                'icon' => 'building',
            ],
            [
                'key' => 'bureaux',
                ...
                'points' => ['Desks and workstations', 'Toilets and kitchens', 'Meeting rooms', 'Floors and surfaces'],
                'icon' => 'briefcase',
            ],
            [
                'key' => 'specifiques',
                'name' => 'Specialist services',
                'summary' => 'Windows, after-works cleaning, disinfection and emergencies.',
                'points' => ['Window cleaning', 'After building works', 'Disinfection', 'Urgent call-outs'],
                'icon' => 'spray',
            ],
        ],
    ],
